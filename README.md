...
AA0003 | Проверка успешной авторизации | **1.** Открыть главную страницу [calcus.ru](https://calcus.ru/) **2.** Кликнуть по ссылке "Вход", открывается всплывающая форма авторизации. **3.** Ввести корректный имейл в поле "Email" **4.** Ввести корректный пароль в поле "Пароль" **5.** Нажать кнопку "Войти" | Email: ronhabb@yandex.ru Пароль: Qwerty123| |
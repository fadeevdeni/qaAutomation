...
AA0003 | Проверка успешной авторизации | **1.** Открыть главную страницу [calcus.ru](https://calcus.ru/) **2.** Кликнуть по ссылке "Вход", открывается всплывающая форма авторизации. **3.** Ввести корректный имейл в поле "Email" **4.** Ввести корректный пароль в поле "Пароль" **5.** Нажать кнопку "Войти" | Email: ronhabb@yandex.ru Пароль: Qwerty123 | Успешная авторизация на сайте. В правом углу появился указанный имейл вместо слова "Войти"| "regress"
AA0004 | Пустое поле "Пароль" | **1.** Открыть главную страницу [calcus.ru](https://calcus.ru/) **2.** Кликнуть по ссылке "Вход", открывается всплывающая форма авторизации. **3.** Ввести корректный имейл в поле "Email" **4.** Поле "Пароль" оставляем пустым **5.** Нажать кнопку "Войти" | Email: ronhabb@yandex.ru Пароль: "пустое поле" | Авторизации не происходит. Для поля "Пароль" выводится сообещение "Заполните это поле." | "regress"
AA0005 | Пустое поле "Email" | **1.** Открыть главную страницу [calcus.ru](https://calcus.ru/) **2.** Кликнуть по ссылке "Вход", открывается всплывающая форма авторизации. **3.** Поле "Email" пустое **4.** Ввести корректный пароль в поле "Пароль" **5.** Нажать кнопку "Войти" | Email: "пустое поле" Пароль: Qwerty123 | Авторизации не происходит. Для поля "Email" выводится сообещение "Заполните это поле." | "regress"
AA0006 | Неверный пароль | **1.** Открыть главную страницу [calcus.ru](https://calcus.ru/) **2.** Кликнуть по ссылке "Вход", открывается всплывающая форма авторизации. **3.** Ввести корректный имейл в поле "Email" **4.** Ввести неправильный пароль **5.** Нажать кнопку "Войти"| Email: ronhabb@yandex.ru Пароль: 321ytrewq | Авторизации не происходит. Под формой авторизации выводится сообщение "Неверный пароль". | "regress"
AA0007 | Неверный email | **1.** Открыть главную страницу [calcus.ru](https://calcus.ru/) **2.** Кликнуть по ссылке "Вход", открывается всплывающая форма авторизации. **3.** Ввести некорректный имейл в поле "Email" **4.** Ввести корректный пароль в поле "Пароль" **5.** Нажать кнопку "Войти" | Email: qwerty321@yandex.ru Пароль: Qwerty123 | Авторизации не происходит. Под формой авторизации выводится сообщение "Пользователь с таким Email не зарегистрирован". | "regress"
AA0008 | Неверный email | **1.** Открыть главную страницу [calcus.ru](https://calcus.ru/) **2.** Кликнуть по ссылке "Вход", открывается всплывающая форма авторизации. **3.** Ввести некорректный имейл в поле "Email" **4.** Ввести корректный пароль в поле "Пароль" **5.** Нажать кнопку "Войти" | Email: ronhabbyandex.ru Пароль: Qwerty123 | Авторизации не происходит. Для поля "Email" выводится сообещение "Адрес электронной почты должен содержать символ "@"." | "regress"